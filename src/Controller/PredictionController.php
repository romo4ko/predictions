...
class PredictionController extends AbstractController
{
    ...
    public function createPrediction(EntityManagerInterface $entityManager, Request $request): Response
    {
    ...
    {
        $prediction = $entityManager->getRepository(Prediction::class)->findOneBy(['type' => 'default']);
